...
$export($export.S + $export.F * !__webpack_require__(43)(function (iter) {
  Array.from(iter);
}), 'Array', {
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(93), __webpack_require__(41)(module)))
...
exports.triggerEvent = exports.appReady = exports.on = undefined;
...
var appReady = function appReady(readyFn) {
...
var _ready = __webpack_require__(225);
...
var _resize = __webpack_require__(266);

var _resize2 = _interopRequireDefault(_resize);

var _vendor = __webpack_require__(267);
...
var bindEvents = function bindEvents() {
  (0, _events.on)(window, 'resize', _lodash2.default.debounce(_resize2.default, 200, false));
};
...
var assignValue = __webpack_require__(212),
    ...
    isPrototype = __webpack_require__(222),
...
var baseRest = __webpack_require__(238),
...
var arrayLikeKeys = __webpack_require__(247),
    baseKeys = __webpack_require__(258),
    isArrayLike = __webpack_require__(209);
...
var root = __webpack_require__(207),
    stubFalse = __webpack_require__(253);
...
var baseIsTypedArray = __webpack_require__(255),
    baseUnary = __webpack_require__(256),
    nodeUtil = __webpack_require__(257);
...
var isPrototype = __webpack_require__(222),
...
var _delegate = __webpack_require__(262);

var _delegate2 = _interopRequireDefault(_delegate);

var _bodyScrollLock = __webpack_require__(264);
...
var closeMenu = function closeMenu() {
	...
	(0, _bodyScrollLock.enableBodyScroll)(el.primaryMenuWrap);
};

var openMenu = function openMenu() {
	document.body.classList.add('menu--opened');
	(0, _bodyScrollLock.disableBodyScroll)(el.primaryMenuWrap);
};
...
var toggleMenu = function toggleMenu(e) {
	e.preventDefault();
	var shouldActivateMenu = !document.body.classList.contains('menu--opened');
...
var closeMenuHandler = function closeMenuHandler(e) {
	e.preventDefault();
	closeMenu();
};
...
var executeResize = function executeResize() {
	var width = getWidth();
	if (width > _config.HEADER_BREAKPOINT) {
		closeMenu();
	}
};
...
var bindEvents = function bindEvents() {
	(0, _events.on)(document, 'diviner/resize', executeResize); // eslint-disable-line
	(0, _delegate2.default)(el.header, '[data-js="header__menu-trigger"]', 'click', toggleMenu);
	(0, _delegate2.default)(el.header, '[data-js="primary-menu__close"]', 'click', closeMenuHandler);
};
...
var HEADER_BREAKPOINT = exports.HEADER_BREAKPOINT = 960;
var WP_ADMIN_BAR_BREAKPOINT = exports.WP_ADMIN_BAR_BREAKPOINT = 783;
var WP_ADMIN_BAR_HEIGHT_MOBILE = exports.WP_ADMIN_BAR_HEIGHT_MOBILE = 46;
var WP_ADMIN_BAR_HEIGHT_DESKTOP = exports.WP_ADMIN_BAR_HEIGHT_DESKTOP = 32;
...
var resize = function resize() {
  ...
  (0, _events.triggerEvent)({ event: 'diviner/resize', native: false });
}; /**
    * @module
    * @exports resize
